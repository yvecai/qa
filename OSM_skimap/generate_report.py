...
def makeJSON():
    ...
    with open('dataReport.json', 'w') as outfile:
...
def getSkimapsParentRegion(fname): # OK
    ...
    # no need to ask again for testing:
    with open('skimaps_regions.json', 'w') as outfile:
...
def main():
    loadSkimapData('skimaps.geojson')
    getSkimapsParentRegion('skimaps_regions.json')
    fillRegions()
    fillDistances()
    makeJSON()
